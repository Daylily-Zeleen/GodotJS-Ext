...
export function makeCopyrightHeader(filename: string): string {
    const lines = [
        "/*******************************************************************************************************",
        ` *  ${filename}`,
        " *******************************************************************************************************",
        " *  This file is Generated by:",
        " *        GodotJS-Ext (https://github.com/Daylily-Zeleen/GodotJS-Ext)",
        " *        - 忘忧の (Daylily-Zeleen) - Contact: daylily-zeleen@foxmail.com",
        " *******************************************************************************************************",
        " */",
        "",
    ];
...
class FileSplitter {
    ...
    constructor(types: TypeDB, path: string) {
        ...
        this._file.store_line("");
        this._file.store_string(makeCopyrightHeader(path.split('/').pop() || 'unknown'));
    }
...
export class TSDCodeGen {
    ...
    async emit(skip_static_types = false) {
        ...
        tasks.add_task("Generating jsb.runtime", () => {
            ...
            try {
                runtime_gen.concatenate(makeCopyrightHeader('jsb.runtime.gen.d.ts'));
    ...
    private emit_scene_node_types(scene_path: string) {
        try {
            ...
            try {
                ...
                file_writer.concatenate(makeCopyrightHeader(file_path.split('/').pop() || 'unknown'));
