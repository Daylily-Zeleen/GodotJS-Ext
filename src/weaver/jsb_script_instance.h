...
protected:
	...
	void free_temporary_method_list() {
		jsb_check(temporary_script_method_list_cache);
		memdelete(temporary_script_method_list_cache);
		temporary_script_method_list_cache = nullptr;
	}
...
#pragma endregion
public:
	GodotJSShadowScriptInstance(const Ref<GodotJSScript> &p_script, Object *p_owner) : GodotJSScriptInstanceBase(p_script, p_owner) {}
};
