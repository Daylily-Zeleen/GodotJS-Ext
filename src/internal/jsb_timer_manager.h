...
struct TimerHandle {
	...
	_FORCE_INLINE_ TimerHandle &operator=(const IndexSafe64 &p_index) {
		id = p_index;
		return *this;
	}

	_FORCE_INLINE_ TimerHandle(const TimerHandle &p_other) : id(p_other.id) {}
	_FORCE_INLINE_ TimerHandle &operator=(const TimerHandle &p_other) {
		id = p_other.id;
		return *this;
	}

	_FORCE_INLINE_ TimerHandle(TimerHandle &&p_other) noexcept : id(p_other.id) {}
	_FORCE_INLINE_ TimerHandle &operator=(TimerHandle &&p_other) noexcept {
		id = p_other.id;
		p_other.id = {};
		return *this;
	}
