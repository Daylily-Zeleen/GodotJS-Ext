...
void _add_script_property(const v8::FunctionCallbackInfo<v8::Value> &info) {
	...
	JSB_LOG(VeryVerbose, "script %s define property(export) %s", _describe_export_name(isolate, context, environment, target), _describe_export_name(isolate, context, environment, details));
}
