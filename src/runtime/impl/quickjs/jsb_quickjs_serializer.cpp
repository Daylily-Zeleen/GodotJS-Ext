...
static const char *typed_array_id_to_name(uint32_t id) {
	switch (static_cast<TypedArrayKind>(id)) {
		case TypedArrayKind::kInt8:
			return "Int8Array";
		case TypedArrayKind::kUint8:
			return "Uint8Array";
		case TypedArrayKind::kUint8Clamped:
			return "Uint8ClampedArray";
		case TypedArrayKind::kInt16:
			return "Int16Array";
		case TypedArrayKind::kUint16:
			return "Uint16Array";
		case TypedArrayKind::kInt32:
			return "Int32Array";
		case TypedArrayKind::kUint32:
			return "Uint32Array";
		case TypedArrayKind::kFloat32:
			return "Float32Array";
		case TypedArrayKind::kFloat64:
			return "Float64Array";
		case TypedArrayKind::kBigInt64:
			return "BigInt64Array";
		case TypedArrayKind::kBigUint64:
